...
/** Крыса в профиль: острая морда слева, ухо, тело, лапы и длинный хвост. */
export function IconRodent(props: IconProps) {
  return (
    <Glyph {...props}>
      {/* Голова с вытянутой мордой и туловище одной линией */}
      <path d="M2.4 14.2 6 12.6c1-1.9 3.1-3 5.4-3 3.4 0 6.1 2.4 6.1 5.4 0 2.1-1.4 3.6-3.4 3.6H7c-2.5 0-4.6-1.4-4.6-3.2Z" />
      {/* Ухо */}
      <circle cx="10.2" cy="11.6" r="1.5" />
      {/* Глаз */}
      <path d="M5.6 13.3h.01" />
      {/* Вибриссы */}
      <path d="M2.6 13.2 1 12.4M2.6 15 1 15.8" />
      {/* Хвост */}
      <path d="M15.1 18.6c2.6.6 4.6-.6 5.2-2.6.5-1.7-.2-3.2-1.5-3.4-1.1-.2-1.8.7-1.5 1.7" />
      {/* Лапы */}
      <path d="M8 18.6v2M12.6 18.6v2" />
    </Glyph>
  );
}
...
/** Блоха: каплевидное тело, хоботок, усики и мощная задняя нога-зигзаг. */
export function IconFlea(props: IconProps) {
  return (
    <Glyph {...props}>
      {/* Тело, сжатое с боков: каплей вниз-влево */}
      <path d="M13.4 5.6c3 1 4.6 4.2 3.6 7.6-1 3.4-4 5.6-6.8 5-2.4-.5-3.6-2.8-3-5.6.7-3.4 3.4-6.6 6.2-7Z" />
      {/* Хоботок */}
      <path d="M8.4 17.6 6 20.4" />
      {/* Усики */}
      <path d="M13.8 5.4 14.6 3M15.8 6.6 18 5.4" />
      {/* Передние лапки */}
      <path d="M9.4 15.4 7 16.6M10.6 18l-1.4 2.2" />
      {/* Прыжковая нога: три колена */}
      <path d="M15.6 14.6 19 16l-1.6 2.8 3 1.4" />
    </Glyph>
  );
}
...
/** Кельма штукатура: треугольное полотно, шейка и ручка — вид сверху сбоку. */
export function IconTrowel(props: IconProps) {
  return (
    <Glyph {...props}>
      {/* Полотно: вытянутый треугольник с закруглённой пяткой */}
      <path d="M3 20.4 14.6 8.8c.6-.6 1.6-.6 2.2 0l.4.4c.6.6.6 1.6 0 2.2L5.6 23" transform="translate(0 -2.6)" />
      {/* Шейка от полотна к ручке */}
      <path d="M15.6 9.4 18 7" />
      {/* Ручка */}
      <rect x="17.6" y="3.2" width="4.6" height="2.6" rx="1.3" transform="rotate(45 19.9 4.5)" />
    </Glyph>
  );
}
