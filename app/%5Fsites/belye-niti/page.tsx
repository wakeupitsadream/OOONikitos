      ...
      <Section id="odin-podryadchik" tone="deep">
        <Reveal>
          <SectionHead
            ...
            lead="Ремонт и санитарная обработка часто нужны подряд. Оформить можно одним договором или отдельными — как удобнее вам. Ответственность в любом случае одна: ООО «Белые Нити»."
          />
        </Reveal>
