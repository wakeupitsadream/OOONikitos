...
export const metadata: Metadata = pageMetadata({
  ...
  description:
    'Штукатурка, шпаклёвка, покраска и обои в Оренбурге. Ровные стены под обои, понятные сроки, фиксированная смета в договоре. Расчёт площади стен и стоимости онлайн.',
});
